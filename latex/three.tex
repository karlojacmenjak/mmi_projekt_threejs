...
\begin{center}
    \includegraphics[scale=0.4]{image/zadatak1.png}
\end{center}
...
varijabla fov koja se koristi za širinu kuta gledanja, aspect za omjer visine i širine pogleda pomoću funkcija
